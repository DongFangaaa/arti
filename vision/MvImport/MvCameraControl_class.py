...
class MvCamera():
    ...
    def __init__(self):
        ...
        self.handle = c_void_p()  # 设备句柄（C 端 void*，直接传地址即可）
    ...
    def MV_CC_CreateHandle(self, stDevInfo):
        ...
        return MvCamCtrldll.MV_CC_CreateHandle(byref(self.handle), stDevInfo)
    ...
    def MV_CC_CreateHandleByGenTL(self, stDevInfo):
        ...
        return MvCamCtrldll.MV_CC_CreateHandleByGenTL(byref(self.handle), stDevInfo)
    ## @}
    ...
    def MV_CC_CreateHandleWithoutLog(self, stDevInfo):
        ...
        return MvCamCtrldll.MV_CC_CreateHandleWithoutLog(byref(self.handle), stDevInfo)
